            ...
            <table style="border-collapse: collapse; width: 100%; background-color: #ecf0f1;">
                <tbody>
                    <tr style="background-color: #ecf0f1; text-align: center; border: 1px solid #CED4D9;">
                        <td style="width: 25.0575%; text-align: left; border-right: 1px solid #b9bdc0; padding: 3px;"><span style="font-family: Montserrat; font-size: 10pt;">Policies: {{ count($rocketPay->policies) }}</span></td>
                        <td style="width: 25.0575%; text-align: left; border-right: 1px solid #b9bdc0; padding: 3px;"><span style="font-family: Montserrat; font-size: 10pt;">Premium: ${{ $rocketPay->prem }}</span></td>
                        <td style="width: 25.0575%; text-align: left; border-right: 1px solid #b9bdc0; padding: 3px;"><span style="font-family: Montserrat; font-size: 10pt;">Commission: ${{ $rocketPay->comm }}</span></td>
                        <td style="width: 25.0575%; text-align: left; border-right: 1px solid #b9bdc0; padding: 3px;"><span style="font-family: Montserrat; font-size: 10pt;">Override: ${{ $rocketPay->override }}</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
